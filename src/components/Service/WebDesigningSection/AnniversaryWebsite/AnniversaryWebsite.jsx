      ...
      <div className='anniversary-website'>
        <Container>
          <div className="anniversary-website-inner">
            <Heading title='anniversary website' />
            <Grid container
            ...
            >
              ...
              >
                <div className="main-work-box">
                  ...
                  <p className="paragraph-subheading">
                  My dedication to responsive design ensures that the websites look perfect on any device, offering a seamless user experience. Ultimately, my work on anniversary websites aims to create a digital celebration that couples and their loved ones will cherish.                  </p>
                </div>
              </Grid>
